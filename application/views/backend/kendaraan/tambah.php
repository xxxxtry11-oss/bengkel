        ...
        <div class="col-md-9">
            ...
            <div class="card glass-card shadow-sm border-0">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                    <h4 class="fw-bold text-primary mb-1"><i class="bi bi-plus-circle me-2"></i> Tambah Kendaraan Baru</h4>
                    <p class="text-muted small mb-0">Lengkapi formulir di bawah ini untuk menambahkan data kendaraan pelanggan.</p>
                </div>

                <div class="card-body">
                    <form action="<?= base_url('backend/kendaraan/simpan') ?>" method="POST" class="needs-validation">
                            ...
                            <?php if (empty($pelanggan)): ?>
                                <div class="alert alert-warning border-0 shadow-sm d-flex align-items-center mb-2" role="alert">
                                    ...
                                    <div>
                                        ...
                                        Anda harus menambahkan data pelanggan terlebih dahulu agar bisa mendaftarkan kendaraan.
                                    </div>
                                </div>
                                <select class="form-select" id="id_pelanggan" name="id_pelanggan" disabled required>
                            ...
                            <?php else: ?>
                                <select class="form-select" id="id_pelanggan" name="id_pelanggan" required>
                                    ...
                                    <?php foreach ($pelanggan as $p): ?>
                                        <option value="<?= $p['id'] ?>" <?= set_select('id_pelanggan', $p['id']) ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control text-uppercase" id="plat_nomor" name="plat_nomor" 
                                   placeholder="Contoh: B 1234 ABC" value="<?= set_value('plat_nomor') ?>" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="merk" name="merk" 
                                       placeholder="Contoh: Honda, Yamaha, Suzuki" value="<?= set_value('merk') ?>" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="tipe" name="tipe" 
                                       placeholder="Contoh: Beat, NMax, GSX" value="<?= set_value('tipe') ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="tahun" name="tahun" required>
                                ...
                                ?>
                                    <option value="<?= $year ?>" <?= set_select('tahun', $year) ?>><?= $year ?></option>
                                <?php endfor; ?>
                            </select>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 border-top pt-3">
                            ...
                            <button type="submit" class="btn btn-primary px-4 shadow-sm" <?= empty($pelanggan) ? 'disabled' : '' ?>>
