...
<div class="topbar">
    <div class="container d-flex justify-content-between align-items-center">
        <div class="brand"><i class="bi bi-tools me-2"></i> Maju Jaya Motor</div>
        <div class="d-flex align-items-center gap-3">
            <span><i class="bi bi-person-circle me-1"></i><?= html_escape($nama) ?></span>
            <span class="badge bg-warning text-dark text-uppercase"><?= html_escape($role) ?></span>
            <a href="<?= base_url('login/logout') ?>" class="text-white text-decoration-none"><i class="bi bi-box-arrow-right me-1"></i> Logout</a>
        </div>
    </div>
</div>
